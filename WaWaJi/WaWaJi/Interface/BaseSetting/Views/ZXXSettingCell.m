...
//        self.accessoryType = UITableViewCellAccessoryDisclosureIndicator;
        self.accessoryView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"next"]];
        ...
        if (item.attribute.rightImageDict) {
            [self.arrowImage sd_setImageWithURL:[NSURL URLWithString:item.attribute.rightImageDict[@"imageUrl"]] placeholderImage:[UIImage imageNamed:item.attribute.rightImageDict[@"placeHolder"]]];
        }else{
    ...
    if (item.attribute.imageDict) {
        [self.imageView sd_setImageWithURL:[NSURL URLWithString:item.attribute.imageDict[@"imageUrl"]] placeholderImage:[UIImage imageNamed:item.attribute.imageDict[@"placeHolder"]]];
    }else{
        if (item.image) {
